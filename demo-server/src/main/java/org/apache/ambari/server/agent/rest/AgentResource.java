...
public class AgentResource
{
    ...
    public RegistrationResponse register(Register message,
                                         @Context HttpServletRequest req) throws WebApplicationException, InvalidStateTransitionException {
    ...
    public HeartBeatResponse heartbeat(
            HeartBeat message) throws WebApplicationException {
    ...
    public ComponentsResponse components(
        ...
        if (LOG.isDebugEnabled())
        {
            LOG.debug("Received Components request for cluster " +
                    clusterName);
        }
