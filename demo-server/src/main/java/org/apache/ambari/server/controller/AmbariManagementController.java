...
public interface AmbariManagementController
{
    ...
    /**
     * Create the cluster defined by the attributes in the given request
     * object.
     *
     * @param request the request object which defines the cluster to
     *                be created
    ...
    /**
     * Create the host component defined by the attributes in the given
     * request object.
     *
     * @param requests the request object which defines the host
     *                 component to be created
     * @throws AmbariException thrown if the host component cannot be
     *                         created
     */
    public void createHostComponents(
            Set<ServiceComponentHostRequest> requests) throws
            AmbariException;
     ...
     *
     * @param requests the request objects which identify the clusters
     *                 to be returned
     ...
     *
     * @param requests the request objects which identify the host
     *                 components
     *                 to be returned
    ...
    Set<ServiceConfigVersionResponse> getServiceConfigVersions(
            Set<ServiceConfigVersionRequest> requests) throws
            AmbariException;
     ...
     *
     * @param requests          request objects which define which
     *                          cluster to
     *                          update and the values to set
     * @param requestProperties request specific properties independent
     *                          of resource
     * @return a track action response
     * @throws AmbariException thrown if the resource cannot be updated
     */
    public RequestStatusResponse updateClusters(
     ...
     *
     * @param request the request object which identifies which cluster
     *                to delete
     ...
     *
     * @param requests the request object which identifies which host
     *                 component to delete
     * @return a track action response
     * @throws AmbariException thrown if the resource cannot be deleted
     */
    ...
    /**
     * Create the action defined by the attributes in the given request
     * object.
     * Used only for custom commands/actions.
     *
     * @param actionRequest     the request object which defines the action
     *                          to be created
    ...
    public Set<StackConfigurationResponse> getStackConfigurations(
            Set<StackConfigurationRequest> requests) throws
            AmbariException;
    ...
    public Set<StackServiceComponentResponse> getStackComponents(
            Set<StackServiceComponentRequest> requests) throws
            AmbariException;
    ...
    /**
     * Get all top-level services of Ambari, not related to certain
     * cluster.
     *
    ...
    /**
     * Get all components of top-level services of Ambari, not related
     * to certain cluster.
     *
    ...
    public Set<RootServiceComponentResponse> getRootServiceComponents(
            Set<RootServiceComponentRequest> requests) throws
            AmbariException;
    ...
    /**
     * Get the root service response factory for this management
     * controller.
     *
     * @return the root service response factory
     */
    public AbstractRootServiceResponseFactory
    ...
    /**
     * Create and persist the request stages and return a response
     * containing the
     ...
     * @param runSmokeTest       indicates whether or not the smoke
     *                           tests should be run
     * @param reconfigureClients indicates whether or not the clients
    ...
    public RequestStatusResponse createAndPersistStages(Cluster cluster,
                                                        ...
                                                        Map<String,
                                                                Map<State, List<ServiceComponentHost>>> changedHosts,
    ...
    public RequestStageContainer addStages(
            ...
            Map<String, Map<State, List<ServiceComponentHost>>>
                    changedHosts,
            Collection<ServiceComponentHost> ignoredHosts,
            boolean runSmokeTest,
            boolean reconfigureClients) throws AmbariException;
    ...
    /**
     * Getter for the url of Oracle JDBC driver, stored at server
     * resources folder
     */
    public String getOjdbcUrl();

    /**
     * Getter for the url of MySQL JDBC driver, stored at server
     * resources folder
     */
    ...
    /**
     * Get cached clusterUpdateResults, used only for service config
     * versions currently
     *
    ...
    /**
     * Get configurations which are specific for a cluster (!not a
     * service).
     *
     * @param requests
     * @return
    ...
    public Set<StackConfigurationResponse> getStackLevelConfigurations(
            Set<StackLevelConfigurationRequest> requests) throws
            AmbariException;

    /**
     * @param serviceInfo service info for a given service
     * @param hostParams  parameter map. May be changed during method
     *                    execution
     * @param osFamily    os family for host
     * @return a full list of package dependencies for a service that
     * should be
     * installed on a host
     */
    List<ServiceOsSpecific.Package> getPackagesForServiceHost(
            ServiceInfo serviceInfo, Map<String, String> hostParams,
            String osFamily);

    /**
     * Register a change in rack information for the hosts of the given
     * cluster.
     *
    ...
    /**
     * Initialize cluster scoped widgets and widgetLayouts for different
     * stack
     * components.
     *
    ...
    /**
     * Get configuration dependencies which are specific for a specific
