...
public class Configuration
{
    ...
    public static final String JDBC_RCA_LOCAL_URL =
            "jdbc:postgresql://" + HOSTNAME_MACRO + "/ambarirca";
    ...
    public enum DatabaseType
    {
        ...
        private static final Map<String, DatabaseType> m_mappedTypes = new HashMap<String, Configuration.DatabaseType>(5);

        static
        {
            for (DatabaseType databaseType : EnumSet
                    .allOf(DatabaseType.class))
            {
    ...
    public Configuration(Properties properties) {
        ...
        agentConfigsMap.put(CHECK_REMOTE_MOUNTS_KEY, properties
                .getProperty(CHECK_REMOTE_MOUNTS_KEY, CHECK_REMOTE_MOUNTS_DEFAULT));
        agentConfigsMap.put(CHECK_MOUNTS_TIMEOUT_KEY, properties
                .getProperty(CHECK_MOUNTS_TIMEOUT_KEY, CHECK_MOUNTS_TIMEOUT_DEFAULT));

        agentConfigsMap.put(ENABLE_AUTO_AGENT_CACHE_UPDATE_KEY, properties
                .getProperty(ENABLE_AUTO_AGENT_CACHE_UPDATE_KEY, ENABLE_AUTO_AGENT_CACHE_UPDATE_DEFAULT));

        configsMap = new HashMap<String, String>();
        configsMap.putAll(agentConfigsMap);
        configsMap.put(AMBARI_PYTHON_WRAP_KEY, properties
                .getProperty(AMBARI_PYTHON_WRAP_KEY, AMBARI_PYTHON_WRAP_DEFAULT));
        configsMap.put(SRVR_TWO_WAY_SSL_KEY, properties
                .getProperty(SRVR_TWO_WAY_SSL_KEY, SRVR_TWO_WAY_SSL_DEFAULT));
        configsMap.put(SRVR_TWO_WAY_SSL_PORT_KEY, properties
                .getProperty(SRVR_TWO_WAY_SSL_PORT_KEY, SRVR_TWO_WAY_SSL_PORT_DEFAULT));
        configsMap.put(SRVR_ONE_WAY_SSL_PORT_KEY, properties
                .getProperty(SRVR_ONE_WAY_SSL_PORT_KEY, SRVR_ONE_WAY_SSL_PORT_DEFAULT));
        configsMap.put(SRVR_KSTR_DIR_KEY, properties
                .getProperty(SRVR_KSTR_DIR_KEY, SRVR_KSTR_DIR_DEFAULT));
        configsMap.put(SRVR_CRT_NAME_KEY, properties
                .getProperty(SRVR_CRT_NAME_KEY, SRVR_CRT_NAME_DEFAULT));
        configsMap.put(SRVR_KEY_NAME_KEY, properties
                .getProperty(SRVR_KEY_NAME_KEY, SRVR_KEY_NAME_DEFAULT));
        configsMap.put(SRVR_CSR_NAME_KEY, properties
                .getProperty(SRVR_CSR_NAME_KEY, SRVR_CSR_NAME_DEFAULT));
        configsMap.put(KSTR_NAME_KEY, properties
                .getProperty(KSTR_NAME_KEY, KSTR_NAME_DEFAULT));
        configsMap.put(KSTR_TYPE_KEY, properties
                .getProperty(KSTR_TYPE_KEY, KSTR_TYPE_DEFAULT));
        configsMap.put(TSTR_NAME_KEY, properties
                .getProperty(TSTR_NAME_KEY, TSTR_NAME_DEFAULT));
        configsMap.put(TSTR_TYPE_KEY, properties
                .getProperty(TSTR_TYPE_KEY, TSTR_TYPE_DEFAULT));
        configsMap.put(SRVR_CRT_PASS_FILE_KEY, properties
                .getProperty(SRVR_CRT_PASS_FILE_KEY, SRVR_CRT_PASS_FILE_DEFAULT));
        configsMap.put(PASSPHRASE_ENV_KEY, properties
                .getProperty(PASSPHRASE_ENV_KEY, PASSPHRASE_ENV_DEFAULT));
        configsMap.put(PASSPHRASE_KEY, System
                .getenv(configsMap.get(PASSPHRASE_ENV_KEY)));
        configsMap.put(RESOURCES_DIR_KEY, properties
                .getProperty(RESOURCES_DIR_KEY, RESOURCES_DIR_DEFAULT));
        configsMap.put(SRVR_CRT_PASS_LEN_KEY, properties
                .getProperty(SRVR_CRT_PASS_LEN_KEY, SRVR_CRT_PASS_LEN_DEFAULT));
        configsMap.put(SRVR_DISABLED_CIPHERS, properties
                .getProperty(SRVR_DISABLED_CIPHERS, SRVR_DISABLED_CIPHERS_DEFAULT));
        configsMap.put(SRVR_DISABLED_PROTOCOLS, properties
                .getProperty(SRVR_DISABLED_PROTOCOLS, SRVR_DISABLED_PROTOCOLS_DEFAULT));

        configsMap.put(CLIENT_API_SSL_KSTR_DIR_NAME_KEY, properties
                .getProperty(CLIENT_API_SSL_KSTR_DIR_NAME_KEY, configsMap
                        .get(SRVR_KSTR_DIR_KEY)));
        configsMap.put(CLIENT_API_SSL_KSTR_NAME_KEY, properties
                .getProperty(CLIENT_API_SSL_KSTR_NAME_KEY, CLIENT_API_SSL_KSTR_NAME_DEFAULT));
        configsMap.put(CLIENT_API_SSL_KSTR_TYPE_KEY, properties
                .getProperty(CLIENT_API_SSL_KSTR_TYPE_KEY, CLIENT_API_SSL_KSTR_TYPE_DEFAULT));
        configsMap.put(CLIENT_API_SSL_TSTR_NAME_KEY, properties
                .getProperty(CLIENT_API_SSL_TSTR_NAME_KEY, CLIENT_API_SSL_TSTR_NAME_DEFAULT));
        configsMap.put(CLIENT_API_SSL_TSTR_TYPE_KEY, properties
                .getProperty(CLIENT_API_SSL_TSTR_TYPE_KEY, CLIENT_API_SSL_TSTR_TYPE_DEFAULT));
        ...
        configsMap.put(CLIENT_API_SSL_KEY_NAME_KEY, properties
                .getProperty(CLIENT_API_SSL_KEY_NAME_KEY, CLIENT_API_SSL_KEY_NAME_DEFAULT));
        configsMap.put(CLIENT_API_SSL_CRT_NAME_KEY, properties
                .getProperty(CLIENT_API_SSL_CRT_NAME_KEY, CLIENT_API_SSL_CRT_NAME_DEFAULT));
        configsMap
                .put(JAVA_HOME_KEY, properties.getProperty(JAVA_HOME_KEY));
        configsMap.put(PARALLEL_STAGE_EXECUTION_KEY, properties
                .getProperty(PARALLEL_STAGE_EXECUTION_KEY, PARALLEL_STAGE_EXECUTION_DEFAULT));
        configsMap.put(SERVER_TMP_DIR_KEY, properties
                .getProperty(SERVER_TMP_DIR_KEY, SERVER_TMP_DIR_DEFAULT));
        configsMap.put(EXTERNAL_SCRIPT_TIMEOUT_KEY, properties
                .getProperty(EXTERNAL_SCRIPT_TIMEOUT_KEY, EXTERNAL_SCRIPT_TIMEOUT_DEFAULT));

        configsMap.put(SHARED_RESOURCES_DIR_KEY, properties
                .getProperty(SHARED_RESOURCES_DIR_KEY, SHARED_RESOURCES_DIR_DEFAULT));

        configsMap.put(KDC_PORT_KEY, properties
                .getProperty(KDC_PORT_KEY, KDC_PORT_KEY_DEFAULT));

        configsMap
                .put(AGENT_PACKAGE_PARALLEL_COMMANDS_LIMIT_KEY, properties
                        .getProperty(AGENT_PACKAGE_PARALLEL_COMMANDS_LIMIT_KEY, AGENT_PACKAGE_PARALLEL_COMMANDS_LIMIT_DEFAULT));
        configsMap.put(PROXY_ALLOWED_HOST_PORTS, properties
                .getProperty(PROXY_ALLOWED_HOST_PORTS, PROXY_ALLOWED_HOST_PORTS_DEFAULT));

        File passFile = new File(
                configsMap.get(SRVR_KSTR_DIR_KEY) + File.separator +
        ...
        if (!passFile.exists())
        {
            ...
            try
            {
                ...
                ShellCommandUtil
                        .setUnixFilePermissions(ShellCommandUtil.MASK_OWNER_ONLY_RW, passFile
                                .getAbsolutePath());
            }
            catch (IOException e)
            {
        ...
        if (getApiSSLAuthentication())
        {
            ...
            File httpsPassFile = new File(
                    configsMap.get(CLIENT_API_SSL_KSTR_DIR_NAME_KEY) +
                            File.separator + configsMap
                            .get(CLIENT_API_SSL_CRT_PASS_FILE_NAME_KEY));
            ...
            if (httpsPassFile.exists())
            {
                ...
                catch (IOException e)
                {
                    ...
                    throw new RuntimeException(
                            "Error reading certificate password from" +
                                    " file " +
                                    httpsPassFile.getAbsolutePath());
                }
            }
            else
            {
                LOG.error("There is no keystore for https UI connection.");
                LOG.error("Run \"ambari-server setup-https\" or set " +
                        Configuration.API_USE_SSL + " = false.");
                throw new RuntimeException(
                        "Error reading certificate password from " +
    ...
    protected void loadSSLParams() {
        ...
        {
            System.setProperty(JAVAX_SSL_TRUSTSTORE, properties
                    .getProperty(SSL_TRUSTSTORE_PATH_KEY));
        }
        if (properties.getProperty(SSL_TRUSTSTORE_PASSWORD_KEY) != null)
        {
            String ts_password = readPasswordFromStore(properties
                    .getProperty(SSL_TRUSTSTORE_PASSWORD_KEY));
            if (ts_password != null)
            {
            ...
            {
                System.setProperty(JAVAX_SSL_TRUSTSTORE_PASSWORD, properties
                        .getProperty(SSL_TRUSTSTORE_PASSWORD_KEY));
            }
        }
        if (properties.getProperty(SSL_TRUSTSTORE_TYPE_KEY) != null)
        {
            System.setProperty(JAVAX_SSL_TRUSTSTORE_TYPE, properties
    ...
    private static Properties readConfigFile() {
        ...
        {
            throw new RuntimeException(
                    CONFIG_FILE + " not found in classpath");
        }
    ...
    public File getViewsDir() {
        String fileName = properties
                .getProperty(VIEWS_DIR, VIEWS_DIR_DEFAULT);
    ...
    public boolean isViewValidationEnabled() {
        return Boolean.parseBoolean(properties
                .getProperty(VIEWS_VALIDATE, VIEWS_VALIDATE_DEFAULT));
    }
    ...
    public boolean isViewRemoveUndeployedEnabled() {
        return Boolean.parseBoolean(properties
                .getProperty(VIEWS_REMOVE_UNDEPLOYED, VIEWS_REMOVE_UNDEPLOYED_DEFAULT));
    }
    ...
    public File getBootStrapDir() {
        String fileName = properties
                .getProperty(BOOTSTRAP_DIR, BOOTSTRAP_DIR_DEFAULT);
        return new File(fileName);
    }

    public String getBootStrapScript() {
        return properties
                .getProperty(BOOTSTRAP_SCRIPT, BOOTSTRAP_SCRIPT_DEFAULT);
    }

    public String getBootSetupAgentScript() {
        return properties
                .getProperty(BOOTSTRAP_SETUP_AGENT_SCRIPT, "/usr/lib/python2.6/site-packages/ambari_server/setupAgent.py");
    }
    ...
    public String getBootSetupAgentPassword() {
        ...
        // fallback
        return properties
                .getProperty(BOOTSTRAP_SETUP_AGENT_PASSWORD, "password");
    }

    public File getRecommendationsDir() {
        String fileName = properties
                .getProperty(RECOMMENDATIONS_DIR, RECOMMENDATIONS_DIR_DEFAULT);
        return new File(fileName);
    }

    public String areHostsSysPrepped() {
        return properties
                .getProperty(SYS_PREPPED_HOSTS_KEY, SYS_PREPPED_HOSTS_DEFAULT);
    }

    public String getStackAdvisorScript() {
        return properties
                .getProperty(STACK_ADVISOR_SCRIPT, STACK_ADVISOR_SCRIPT_DEFAULT);
    }

    public String getRollingUpgradeMinStack() {
        return properties
                .getProperty(ROLLING_UPGRADE_MIN_STACK_KEY, ROLLING_UPGRADE_MIN_STACK_DEFAULT);
    }

    public String getRollingUpgradeMaxStack() {
        return properties
                .getProperty(ROLLING_UPGRADE_MAX_STACK_KEY, ROLLING_UPGRADE_MAX_STACK_DEFAULT);
    }
    ...
    public boolean csrfProtectionEnabled() {
        return "true".equalsIgnoreCase(properties
                .getProperty(API_CSRF_PREVENTION_KEY, API_CSRF_PREVENTION_DEFAULT));
    }
    ...
    public ClientSecurityType getClientSecurityType() {
        return ClientSecurityType
                .fromString(properties.getProperty(CLIENT_SECURITY_KEY));
    }
    ...
    public void setLdap(String host, String userClass, String userNameAttr,
                        String groupClass, String groupName,
                        String groupMember, String baseDN, boolean anon,
                        String managerDN, String managerPass) {
        ...
        properties
                .setProperty(LDAP_GROUP_MEMEBERSHIP_ATTR_KEY, groupMember);
        properties.setProperty(LDAP_BASE_DN_KEY, baseDN);
        properties.setProperty(LDAP_BIND_ANONYMOUSLY_KEY, String
                .valueOf(anon));
    ...
    public boolean getApiAuthentication() {
        return ("true".equals(properties
                .getProperty(API_AUTHENTICATE, "false")));
    }
    ...
    public int getClientSSLApiPort() {
        return Integer.parseInt(properties
                .getProperty(CLIENT_API_SSL_PORT_KEY, String
                        .valueOf(CLIENT_API_SSL_PORT_DEFAULT)));
    }
    ...
    public boolean getApiSSLAuthentication() {
        return ("true"
                .equals(properties.getProperty(API_USE_SSL, "false")));
    }
    ...
    public String getStrictTransportSecurityHTTPResponseHeader() {
        return properties
                .getProperty(HTTP_STRICT_TRANSPORT_HEADER_VALUE_KEY, HTTP_STRICT_TRANSPORT_HEADER_VALUE_DEFAULT);
    }
    ...
    public String getXFrameOptionsHTTPResponseHeader() {
        return properties
                .getProperty(HTTP_X_FRAME_OPTIONS_HEADER_VALUE_KEY, HTTP_X_FRAME_OPTIONS_HEADER_VALUE_DEFAULT);
    }
    ...
    public String getXXSSProtectionHTTPResponseHeader() {
        return properties
                .getProperty(HTTP_X_XSS_PROTECTION_HEADER_VALUE_KEY, HTTP_X_XSS_PROTECTION_HEADER_VALUE_DEFAULT);
    }
    ...
    public boolean isApiGzipped() {
        return "true".equalsIgnoreCase(properties
                .getProperty(API_GZIP_COMPRESSION_ENABLED_KEY, API_GZIP_COMPRESSION_ENABLED_DEFAULT));
    }
    ...
    public boolean isAgentApiGzipped() {
        return "true".equalsIgnoreCase(properties
                .getProperty(AGENT_API_GZIP_COMPRESSION_ENABLED_KEY, API_GZIP_COMPRESSION_ENABLED_DEFAULT));
    }
    ...
    public String getApiGzipMinSize() {
        return properties
                .getProperty(API_GZIP_MIN_COMPRESSION_SIZE_KEY, API_GZIP_MIN_COMPRESSION_SIZE_DEFAULT);
    }
    ...
    public PersistenceType getPersistenceType() {
        String value = properties
                .getProperty(SERVER_PERSISTENCE_TYPE_KEY, SERVER_PERSISTENCE_TYPE_DEFAULT);
    ...
    public String getDatabaseDriver() {
        ...
        {
            return properties
                    .getProperty(SERVER_JDBC_DRIVER_KEY, JDBC_LOCAL_DRIVER);
        }
        else
        {
    ...
    public String getDatabaseUser() {
        return properties
                .getProperty(SERVER_JDBC_USER_NAME_KEY, SERVER_JDBC_USER_NAME_DEFAULT);
    }

    public String getDatabasePassword() {
        String passwdProp = properties
                .getProperty(SERVER_JDBC_USER_PASSWD_KEY);
    ...
    public String getRcaDatabaseDriver() {
        return properties
                .getProperty(SERVER_JDBC_RCA_DRIVER_KEY, JDBC_RCA_LOCAL_DRIVER);
    }

    public String getRcaDatabaseUrl() {
        return properties
                .getProperty(SERVER_JDBC_RCA_URL_KEY, JDBC_RCA_LOCAL_URL);
    }

    public String getRcaDatabaseUser() {
        return properties
                .getProperty(SERVER_JDBC_RCA_USER_NAME_KEY, SERVER_JDBC_RCA_USER_NAME_DEFAULT);
    }

    public String getRcaDatabasePassword() {
        String passwdProp = properties
                .getProperty(SERVER_JDBC_RCA_USER_PASSWD_KEY);
        if (passwdProp != null)
        {
    ...
    public LdapServerProperties getLdapServerProperties() {
        ...
        ldapServerProperties.setPrimaryUrl(properties
                .getProperty(LDAP_PRIMARY_URL_KEY, LDAP_PRIMARY_URL_DEFAULT));
        ldapServerProperties.setSecondaryUrl(properties
                .getProperty(LDAP_SECONDARY_URL_KEY));
        ...
        ldapServerProperties.setAnonymousBind("true".
                                                            equalsIgnoreCase(properties
                                                                    .getProperty(LDAP_BIND_ANONYMOUSLY_KEY, LDAP_BIND_ANONYMOUSLY_DEFAULT)));
        ldapServerProperties
                .setManagerDn(properties.getProperty(LDAP_MANAGER_DN_KEY));
        String ldapPasswordProperty = properties
        ...
        {
            if (ldapPasswordProperty != null &&
                    new File(ldapPasswordProperty).exists())
            {
                ldapServerProperties
                        .setManagerPassword(readPasswordFromFile(ldapPasswordProperty, ""));
            }
        }
        ldapServerProperties.setBaseDN(properties
                .getProperty(LDAP_BASE_DN_KEY, LDAP_BASE_DN_DEFAULT));
        ...
        ldapServerProperties.setUserBase(properties
                .getProperty(LDAP_USER_BASE_KEY, LDAP_USER_BASE_DEFAULT));
        ldapServerProperties.setUserObjectClass(properties
                .getProperty(LDAP_USER_OBJECT_CLASS_KEY, LDAP_USER_OBJECT_CLASS_DEFAULT));
        ldapServerProperties.setDnAttribute(properties
                .getProperty(LDAP_DN_ATTRIBUTE_KEY, LDAP_DN_ATTRIBUTE_DEFAULT));
        ...
        ldapServerProperties.setGroupMembershipAttr(properties
                .getProperty(LDAP_GROUP_MEMEBERSHIP_ATTR_KEY, LDAP_GROUP_MEMBERSHIP_ATTR_DEFAULT));
        ldapServerProperties.setGroupNamingAttr(properties.
                                                                  getProperty(LDAP_GROUP_NAMING_ATTR_KEY, LDAP_GROUP_NAMING_ATTR_DEFAULT));
        ldapServerProperties.setAdminGroupMappingRules(properties
                .getProperty(LDAP_ADMIN_GROUP_MAPPING_RULES_KEY, LDAP_ADMIN_GROUP_MAPPING_RULES_DEFAULT));
        ldapServerProperties.setGroupSearchFilter(properties
                .getProperty(LDAP_GROUP_SEARCH_FILTER_KEY, LDAP_GROUP_SEARCH_FILTER_DEFAULT));
        ldapServerProperties.setReferralMethod(properties
                .getProperty(LDAP_REFERRAL_KEY, LDAP_REFERRAL_DEFAULT));
        ldapServerProperties.setPaginationEnabled("true"
                .equalsIgnoreCase(properties
                        .getProperty(LDAP_PAGINATION_ENABLED_KEY, LDAP_PAGINATION_ENABLED_DEFAULT)));
        ...
        if (properties.containsKey(LDAP_GROUP_BASE_KEY) ||
                ...
                properties
                        .containsKey(LDAP_ADMIN_GROUP_MAPPING_RULES_KEY) ||
    ...
    public boolean isLdapConfigured() {
        return Boolean.parseBoolean(properties
                .getProperty(IS_LDAP_CONFIGURED, IS_LDAP_CONFIGURED_DEFAULT));
    }
    ...
    public String getMasterHostname(String defaultValue) {
        return properties
                .getProperty(BOOTSTRAP_MASTER_HOSTNAME, defaultValue);
    }

    public int getClientApiPort() {
        return Integer.parseInt(properties
                .getProperty(CLIENT_API_PORT_KEY, String
                        .valueOf(CLIENT_API_PORT_DEFAULT)));
    }

    public String getOjdbcJarName() {
        return properties
                .getProperty(OJDBC_JAR_NAME_KEY, OJDBC_JAR_NAME_DEFAULT);
    }
    ...
    public String getServerDBName() {
        return properties
                .getProperty(SERVER_DB_NAME_KEY, SERVER_DB_NAME_DEFAULT);
    }

    public String getMySQLJarName() {
        return properties
                .getProperty(MYSQL_JAR_NAME_KEY, MYSQL_JAR_NAME_DEFAULT);
    }

    public JPATableGenerationStrategy getJPATableGenerationStrategy() {
        return JPATableGenerationStrategy.fromString(System
                .getProperty(SERVER_JDBC_GENERATE_TABLES_KEY));
    }

    public int getConnectionMaxIdleTime() {
        return Integer.parseInt(properties
                .getProperty(SERVER_CONNECTION_MAX_IDLE_TIME, String
                        .valueOf("900000")));
    }
    ...
    public String getAnonymousAuditName() {
        return properties
                .getProperty(ANONYMOUS_AUDIT_NAME_KEY, "_anonymous");
    }
    ...
    public File getServerKeyStoreDirectory() {
        String path = properties
                .getProperty(SRVR_KSTR_DIR_KEY, SRVR_KSTR_DIR_DEFAULT);
        return ((path == null) || path.isEmpty()) ? new File(".") :
                new File(path);
    }
    ...
    public File getMasterKeyLocation() {
        ...
        if (StringUtils.isEmpty(path))
        {
            ...
            LOG.debug("Value of {} is not set, using {}", MASTER_KEY_LOCATION, location
                    .getAbsolutePath());
        }
        else
        {
            location = new File(path, MASTER_KEY_FILENAME_DEFAULT);
            LOG.debug("Value of {} is {}", MASTER_KEY_LOCATION, location
                    .getAbsolutePath());
        }
    ...
    public File getMasterKeyStoreLocation() {
        ...
        if (StringUtils.isEmpty(path))
        {
            ...
            LOG.debug("Value of {} is not set, using {}", MASTER_KEYSTORE_LOCATION, location
                    .getAbsolutePath());
        }
        else
        {
            location = new File(path, MASTER_KEYSTORE_FILENAME_DEFAULT);
            LOG.debug("Value of {} is {}", MASTER_KEYSTORE_LOCATION, location
                    .getAbsolutePath());
        }
    ...
    public long getTemporaryKeyStoreRetentionMinutes() {
        long minutes;
        String value = properties
                .getProperty(TEMPORARY_KEYSTORE_RETENTION_MINUTES);

        if (StringUtils.isEmpty(value))
        {
            LOG.debug("Value of {} is not set, using default value ({})", TEMPORARY_KEYSTORE_RETENTION_MINUTES, TEMPORARY_KEYSTORE_RETENTION_MINUTES_DEFAULT);
        ...
        else
        {
            ...
            {
                LOG.warn("Value of {} ({}) should be a number, falling back to default value ({})", TEMPORARY_KEYSTORE_RETENTION_MINUTES, value, TEMPORARY_KEYSTORE_RETENTION_MINUTES_DEFAULT);
                minutes = TEMPORARY_KEYSTORE_RETENTION_MINUTES_DEFAULT;
            }
        }
    ...
    public boolean isActivelyPurgeTemporaryKeyStore() {
        String value = properties
                .getProperty(TEMPORARY_KEYSTORE_ACTIVELY_PURGE);

        if (StringUtils.isEmpty(value))
        {
            LOG.debug("Value of {} is not set, using default value ({})", TEMPORARY_KEYSTORE_ACTIVELY_PURGE, TEMPORARY_KEYSTORE_ACTIVELY_PURGE_DEFAULT);
        ...
        {
            LOG.warn("Value of {} should be either \"true\" or \"false\" but is \"{}\", falling back to default value ({})", TEMPORARY_KEYSTORE_ACTIVELY_PURGE, value, TEMPORARY_KEYSTORE_ACTIVELY_PURGE_DEFAULT);
            return TEMPORARY_KEYSTORE_ACTIVELY_PURGE_DEFAULT;
        }
    }

    public String getSrvrDisabledCiphers() {
        String disabledCiphers = properties
                .getProperty(SRVR_DISABLED_CIPHERS, properties
                        .getProperty(SRVR_DISABLED_CIPHERS, SRVR_DISABLED_CIPHERS_DEFAULT));
        return disabledCiphers.trim();
    }

    public String getSrvrDisabledProtocols() {
        String disabledProtocols = properties
                .getProperty(SRVR_DISABLED_PROTOCOLS, properties
                        .getProperty(SRVR_DISABLED_PROTOCOLS, SRVR_DISABLED_PROTOCOLS_DEFAULT));
    ...
    public int getOneWayAuthPort() {
        return Integer.parseInt(properties
                .getProperty(SRVR_ONE_WAY_SSL_PORT_KEY, String
                        .valueOf(SRVR_ONE_WAY_SSL_PORT_DEFAULT)));
    }

    public int getTwoWayAuthPort() {
        return Integer.parseInt(properties
                .getProperty(SRVR_TWO_WAY_SSL_PORT_KEY, String
                        .valueOf(SRVR_TWO_WAY_SSL_PORT_DEFAULT)));
    }
    ...
    public Map<String, String> getDatabaseCustomProperties() {
        ...
        for (Entry<Object, Object> entry : properties.entrySet())
        {
            ...
            {
                customDbProperties
                        .put(key.substring(SERVER_JDBC_PROPERTIES_PREFIX
                                .length()), val);
            }
        }
    ...
    public boolean isStaleConfigCacheEnabled() {
        String stringValue = properties
                .getProperty(SERVER_STALE_CONFIG_CACHE_ENABLED_KEY, SERVER_STALE_CONFIG_CACHE_ENABLED_DEFAULT);
    ...
    public String[] getRepoValidationSuffixes(String osType) {
        ...
        {
            repoSuffixes = properties
                    .getProperty(REPO_SUFFIX_KEY_UBUNTU, REPO_SUFFIX_UBUNTU);
        }
        else
        {
            repoSuffixes = properties
                    .getProperty(REPO_SUFFIX_KEY_DEFAULT, REPO_SUFFIX_DEFAULT);
        }
    ...
    public String isExecutionSchedulerClusterd() {
        return properties
                .getProperty(EXECUTION_SCHEDULER_CLUSTERED, "false");
    }

    public String getExecutionSchedulerThreads() {
        return properties
                .getProperty(EXECUTION_SCHEDULER_THREADS, DEFAULT_SCHEDULER_THREAD_COUNT);
    }

    public Integer getRequestReadTimeout() {
        return Integer.parseInt(properties
                .getProperty(REQUEST_READ_TIMEOUT, REQUEST_READ_TIMEOUT_DEFAULT));
    }

    public Integer getRequestConnectTimeout() {
        return Integer.parseInt(properties
                .getProperty(REQUEST_CONNECT_TIMEOUT, REQUEST_CONNECT_TIMEOUT_DEFAULT));
    }

    public String getExecutionSchedulerConnections() {
        return properties
                .getProperty(EXECUTION_SCHEDULER_CONNECTIONS, DEFAULT_SCHEDULER_MAX_CONNECTIONS);
    }

    public Long getExecutionSchedulerMisfireToleration() {
        String limit = properties
                .getProperty(EXECUTION_SCHEDULER_MISFIRE_TOLERATION, DEFAULT_EXECUTION_SCHEDULER_MISFIRE_TOLERATION);
        return Long.parseLong(limit);
    }

    public Integer getExecutionSchedulerStartDelay() {
        String delay = properties
                .getProperty(EXECUTION_SCHEDULER_START_DELAY, DEFAULT_SCHEDULER_START_DELAY_SECONDS);
    ...
    public boolean getParallelStageExecution() {
        return "true".equalsIgnoreCase(configsMap
                .get(PARALLEL_STAGE_EXECUTION_KEY));
    }

    public String getCustomActionDefinitionPath() {
        return properties
                .getProperty(CUSTOM_ACTION_DEFINITION_KEY, CUSTOM_ACTION_DEFINITION_DEF_VALUE);
    }
    ...
    public String getDefaultAgentTaskTimeout(
            boolean isPackageInstallationTask) {
        ...
        String defaultValue = isPackageInstallationTask ?
                AGENT_PACKAGE_INSTALL_TASK_TIMEOUT_DEFAULT :
        ...
        {
            LOG.warn(String
                    .format("Value of %s (%s) should be a number, " +
                            "falling back to default value (%s)", key, value, defaultValue));
            return defaultValue;
        }
    }
    ...
    public String getServerJDBCPostgresSchemaName() {
        return properties
                .getProperty(SERVER_JDBC_POSTGRES_SCHEMA_NAME, "");
    }
    ...
    public int getClientThreadPoolSize() {
        return Integer.parseInt(properties
                .getProperty(CLIENT_THREADPOOL_SIZE_KEY, String
                        .valueOf(CLIENT_THREADPOOL_SIZE_DEFAULT)));
    }
    ...
    public int getAgentThreadPoolSize() {
        return Integer.parseInt(properties
                .getProperty(AGENT_THREADPOOL_SIZE_KEY, String
                        .valueOf(AGENT_THREADPOOL_SIZE_DEFAULT)));
    }
    ...
    public int getViewExtractionThreadPoolMaxSize() {
        return Integer.parseInt(properties
                .getProperty(VIEW_EXTRACTION_THREADPOOL_MAX_SIZE_KEY, String
                        .valueOf(VIEW_EXTRACTION_THREADPOOL_MAX_SIZE_DEFAULT)));
    }
    ...
    public int getViewExtractionThreadPoolCoreSize() {
        return Integer.parseInt(properties
                .getProperty(VIEW_EXTRACTION_THREADPOOL_CORE_SIZE_KEY, String
                        .valueOf(VIEW_EXTRACTION_THREADPOOL_CORE_SIZE_DEFAULT)));
    }
    ...
    public long getViewExtractionThreadPoolTimeout() {
        return Long.parseLong(properties
                .getProperty(VIEW_EXTRACTION_THREADPOOL_TIMEOUT_KEY, String
                        .valueOf(VIEW_EXTRACTION_THREADPOOL_TIMEOUT_DEFAULT)));
    }
    ...
    public int getHttpSessionInactiveTimeout() {
        return Integer.parseInt(properties
                .getProperty(SERVER_HTTP_SESSION_INACTIVE_TIMEOUT, "1800"));
    }
    ...
    public int getAlertEventPublisherPoolSize() {
        return Integer.parseInt(properties
                .getProperty(ALERTS_EXECUTION_SCHEDULER_THREADS_KEY, ALERTS_EXECUTION_SCHEDULER_THREADS_DEFAULT));
    }
    ...
    public String getNodeRecoveryType() {
        return properties
                .getProperty(RECOVERY_TYPE_KEY, RECOVERY_TYPE_DEFAULT);
    }
    ...
    public String getNodeRecoveryMaxCount() {
        return properties
                .getProperty(RECOVERY_MAX_COUNT_KEY, RECOVERY_MAX_COUNT_DEFAULT);
    }
    ...
    public String getNodeRecoveryLifetimeMaxCount() {
        return properties
                .getProperty(RECOVERY_LIFETIME_MAX_COUNT_KEY, RECOVERY_LIFETIME_MAX_COUNT_DEFAULT);
    }
    ...
    public String getNodeRecoveryWindowInMin() {
        return properties
                .getProperty(RECOVERY_WINDOW_IN_MIN_KEY, RECOVERY_WINDOW_IN_MIN_DEFAULT);
    }
    ...
    public String getNodeRecoveryRetryGap() {
        return properties
                .getProperty(RECOVERY_RETRY_GAP_KEY, RECOVERY_RETRY_GAP_DEFAULT);
    }
    ...
    public int getKdcConnectionCheckTimeout() {
        return Integer.parseInt(properties
                .getProperty(KDC_CONNECTION_CHECK_TIMEOUT_KEY, KDC_CONNECTION_CHECK_TIMEOUT_DEFAULT));
    }
    ...
    public File getKerberosKeytabCacheDir() {
        String fileName = properties
                .getProperty(KERBEROS_KEYTAB_CACHE_DIR_KEY, KERBEROS_KEYTAB_CACHE_DIR_DEFAULT);
        return new File(fileName);
    }
     ...
     * @throws RuntimeException if there no known database type.
     */
    ...
    public ConnectionPoolType getConnectionPoolType() {
        String connectionPoolType = properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL, ConnectionPoolType.INTERNAL
                        .getName());
    ...
    public int getConnectionPoolMinimumSize() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_MIN_SIZE, DEFAULT_JDBC_POOL_MIN_CONNECTIONS));
    }
    ...
    public int getConnectionPoolMaximumSize() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_MAX_SIZE, DEFAULT_JDBC_POOL_MAX_CONNECTIONS));
    }
    ...
    public int getConnectionPoolMaximumAge() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_MAX_AGE, DEFAULT_JDBC_POOL_MAX_AGE_SECONDS));
    }
    ...
    public int getConnectionPoolMaximumIdle() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_MAX_IDLE_TIME, DEFAULT_JDBC_POOL_MAX_IDLE_TIME_SECONDS));
    }
    ...
    public int getConnectionPoolMaximumExcessIdle() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_MAX_IDLE_TIME_EXCESS, DEFAULT_JDBC_POOL_EXCESS_MAX_IDLE_TIME_SECONDS));
    }
    ...
    public int getConnectionPoolAcquisitionSize() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_AQUISITION_SIZE, DEFAULT_JDBC_POOL_ACQUISITION_SIZE));
    }
    ...
    public int getConnectionPoolAcquisitionRetryAttempts() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_ACQUISITION_RETRY_ATTEMPTS, DEFAULT_JDBC_POOL_ACQUISITION_RETRY_ATTEMPTS));
    }
    ...
    public int getConnectionPoolAcquisitionRetryDelay() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_ACQUISITION_RETRY_DELAY, DEFAULT_JDBC_POOL_ACQUISITION_RETRY_DELAY));
    }
    ...
    public int getConnectionPoolIdleTestInternval() {
        return Integer.parseInt(properties
                .getProperty(SERVER_JDBC_CONNECTION_POOL_IDLE_TEST_INTERVAL, DEFAULT_JDBC_POOL_IDLE_TEST_INTERVAL));
    }
    ...
    public int getMetricCacheMaxEntries() {
        return Integer.parseInt(properties
                .getProperty(TIMELINE_METRICS_CACHE_MAX_ENTRIES, DEFAULT_TIMELINE_METRICS_CACHE_MAX_ENTRIES));
    }
    ...
    public int getMetricCacheTTLSeconds() {
        return Integer.parseInt(properties
                .getProperty(TIMELINE_METRICS_CACHE_TTL, DEFAULT_TIMELINE_METRICS_CACHE_TTL));
    }
    ...
    public int getMetricCacheIdleSeconds() {
        return Integer.parseInt(properties
                .getProperty(TIMELINE_METRICS_CACHE_IDLE_TIME, DEFAULT_TIMELINE_METRICS_CACHE_IDLE_TIME));
    }
    ...
    public int getMetricsRequestReadTimeoutMillis() {
        return Integer.parseInt(properties
                .getProperty(TIMELINE_METRICS_REQUEST_READ_TIMEOUT, DEFAULT_TIMELINE_METRICS_REQUEST_READ_TIMEOUT));
    }
    ...
    public int getMetricsRequestIntervalReadTimeoutMillis() {
        return Integer.parseInt(properties
                .getProperty(TIMELINE_METRICS_REQUEST_INTERVAL_READ_TIMEOUT, DEFAULT_TIMELINE_METRICS_REQUEST_INTERVAL_READ_TIMEOUT));
    }
    ...
    public int getMetricsRequestConnectTimeoutMillis() {
        return Integer.parseInt(properties
                .getProperty(TIMELINE_METRICS_REQUEST_CONNECT_TIMEOUT, DEFAULT_TIMELINE_METRICS_REQUEST_CONNECT_TIMEOUT));
    }
    ...
    public boolean isMetricsCacheDisabled() {
        return Boolean.parseBoolean(properties
                .getProperty(TIMELINE_METRICS_CACHE_DISABLE, "false"));
    }
    ...
    public Long getMetricRequestBufferTimeCatchupInterval() {
        return Long.parseLong(properties
                .getProperty(TIMELINE_METRICS_REQUEST_CATCHUP_INTERVAL, DEFAULT_TIMELINE_METRICS_REQUEST_CATCHUP_INTERVAL));
    }
    ...
    public String getMetricsCacheManagerHeapPercent() {
        String percent = properties
                .getProperty(TIMELINE_METRICS_CACHE_HEAP_PERCENT, DEFAULT_TIMELINE_METRICS_CACHE_HEAP_PERCENT);

        return percent.trim().endsWith("%") ? percent.trim() :
                percent.trim() + "%";
    }
    ...
    public boolean isExperimentalConcurrentStageProcessingEnabled() {
        return Boolean.parseBoolean(properties
                .getProperty(EXPERIMENTAL_CONCURRENCY_STAGE_PROCESSING_ENABLED, Boolean.FALSE
                        .toString()));
    }
}
