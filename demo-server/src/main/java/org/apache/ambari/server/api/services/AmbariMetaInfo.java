...
public class AmbariMetaInfo
{
    ...
    public void init() throws Exception {
        ...
        stackManager = stackManagerFactory
                .create(stackRoot, commonServicesRoot, osFamily);
    ...
    public List<ComponentInfo> getComponentsByService(String stackName,
        ...
        catch (StackAccessException e)
        {
            throw new ParentObjectNotFoundException(
                    "Parent Service resource doesn't exist. stackName=" +
                            stackName + ", stackVersion=" + version +
                            ", serviceName=" + serviceName);
        }
        return service.getComponents();
    }

    public ComponentInfo getComponent(String stackName, String version,
                                      String serviceName,
                                      String componentName) throws AmbariException {

        ComponentInfo component = getService(stackName, version, serviceName)
                .getComponentByName(componentName);

        if (component == null)
        {
            throw new StackAccessException(
                    "stackName=" + stackName + ", stackVersion=" +
     ...
     */
    public List<DependencyInfo> getComponentDependencies(String stackName,
                                                         String version,
                                                         String service,
                                                         String component) throws AmbariException {
     ...
     */
    public DependencyInfo getComponentDependency(String stackName,
                                                 String version,
                                                 String service,
                                                 String component,
                                                 String dependencyName) throws AmbariException {
    ...
    public Map<String, List<RepositoryInfo>> getRepository(
            String stackName, String version) throws AmbariException {
        ...
        for (RepositoryInfo repo : repository)
        {
            ...
            {
                reposResult.put(repo
                        .getOsType(), new ArrayList<RepositoryInfo>());
            }
    ...
    public RepositoryInfo getRepository(String stackName, String version,
                                        String osType,
                                        String repoId) throws AmbariException {
     ...
     * support isValidService(), isValidComponent for a given stack/version
     */
    public boolean isValidServiceComponent(String stackName,
                                           String version,
                                           String serviceName,
    ...
    public String getComponentToService(String stackName, String version,
        ...
        {
            LOG.debug(
                    "Looking for service for component" + ", stackName=" +
                            stackName + ", stackVersion=" + version +
                            ", componentName=" + componentName);
        }
        ...
        {
            ComponentInfo vu = entry.getValue()
                                    .getComponentByName(componentName);
            if (vu != null)
            {
     ...
     * @throws AmbariException
     */
    public Map<String, ServiceInfo> getServices(String stackName,
    ...
    public ServiceInfo getService(String stackName, String version,
                                  String serviceName) throws AmbariException {
        ServiceInfo service = getStack(stackName, version)
    ...
    public Collection<String> getMonitoringServiceNames(String stackName,
                                                        String version) throws AmbariException {

        List<String> monitoringServices = new ArrayList<String>();
        for (ServiceInfo service : getServices(stackName, version)
                .values())
        {
    ...
    public Set<String> getRestartRequiredServicesNames(String stackName,
                                                       String version) throws AmbariException {

        HashSet<String> needRestartServices = new HashSet<String>();
        Collection<ServiceInfo> serviceInfos = getServices(stackName, version)
                .values();

        for (ServiceInfo service : serviceInfos)
        {

            Boolean restartRequiredAfterChange = service
                    .isRestartRequiredAfterChange();

            if (restartRequiredAfterChange != null &&
     ...
     */
    public Set<String> getRackSensitiveServicesNames(String stackName,
                                                     String version) throws AmbariException {
        ...
        for (ServiceInfo service : serviceInfos)
        {
            ...
            Boolean restartRequiredAfterRackChange = service
    ...
    public Collection<StackInfo> getStacks(
            String stackName) throws AmbariException {
    ...
    public StackInfo getStack(String stackName,
                              String version) throws AmbariException {
        StackInfo stackInfoResult = stackManager
                .getStack(stackName, version);

        if (stackInfoResult == null)
        {
            throw new StackAccessException(
                    "Stack " + stackName + " " + version +
    ...
    public List<String> getStackParentVersions(String stackName,
                                               String version) {
    ...
    public Set<PropertyInfo> getServiceProperties(String stackName,
                                                  String version,
                                                  String serviceName) throws AmbariException {

        return new HashSet<PropertyInfo>(getService(stackName, version, serviceName)
                .getProperties());
    }

    public Set<PropertyInfo> getStackProperties(String stackName,
                                                String version) throws AmbariException {

        return new HashSet<PropertyInfo>(getStack(stackName, version)
                .getProperties());
    }

    public Set<PropertyInfo> getPropertiesByName(String stackName,
                                                 String version,
                                                 String serviceName,
                                                 String propertyName) throws AmbariException {
    ...
    public Set<PropertyInfo> getStackPropertiesByName(String stackName,
                                                      String version,
                                                      String propertyName) throws AmbariException {
     ...
     */
    public Set<OperatingSystemInfo> getOperatingSystems(String stackName,
                                                        String version) throws AmbariException {
        ...
        {
            operatingSystems
                    .add(new OperatingSystemInfo(repository.getOsType()));
        }

        return operatingSystems;
    }

    public OperatingSystemInfo getOperatingSystem(String stackName,
                                                  String version,
                                                  String osType) throws AmbariException {
    ...
    private void getCustomActionDefinitions(
            File customActionDefinitionRoot) throws JAXBException, AmbariException {
        if (customActionDefinitionRoot != null)
        {
            ...
            if (customActionDefinitionRoot.exists() &&
                    customActionDefinitionRoot.isDirectory())
            {
                adManager
                        .readCustomActionDefinitions(customActionDefinitionRoot);
            }
            else
            {
                LOG.debug("No action definitions found at " +
                        customActionDefinitionRoot.getAbsolutePath());
            }
        }
    }
     ...
     */
    public void addActionDefinition(
            ActionDefinition ad) throws AmbariException {
     ...
     */
    public static String generateRepoMetaKey(String stackName,
                                             String stackVersion,
     ...
     */
    public void updateRepoBaseURL(String stackName, String stackVersion,
                                  String osType, String repoId,
                                  String newBaseUrl) throws AmbariException {
     ...
     */
    public Map<String, Map<String, List<MetricDefinition>>> getServiceMetrics(
        ...
        {
            LOG.debug(
                    "Metrics file for " + stackName + "/" + stackVersion +
                            "/" + serviceName + " not found.");
            return null;
        }

        Map<String, Map<String, List<MetricDefinition>>> map = svc
                .getMetrics();
        ...
        if (null == map)
        {
            ...
            try
            {
                map = gson.fromJson(new FileReader(svc
                        .getMetricsFile()), type);
    ...
    private Map<String, Map<String, List<MetricDefinition>>> updateComponentMetricMapWithAggregateFunctionIds(
        ...
        {
            // For every Component
            for (Map<String, List<MetricDefinition>> componentMetricDef : metricMap
                    .values())
            {
                // For every Component / HostComponent category
                for (Map.Entry<String, List<MetricDefinition>> metricDefEntry : componentMetricDef
                        .entrySet())
                {
                    ...
                    if (metricDefEntry.getKey().equals(Component.name()))
                    {
                        ...
                        for (MetricDefinition metricDefinition : metricDefEntry
                                .getValue())
                        {
                            // Metrics System metrics only
                            if (metricDefinition.getType()
                                                .equals("ganglia"))
                            {
                                // Create a new map for each category
                                for (Map<String, Metric> metricByCategory : metricDefinition
                                        .getMetricsByCategory().values())
                                {
                                    ...
                                    for (String identifierToAdd : AGGREGATE_FUNCTION_IDENTIFIERS)
                                    {
                                        ...
                                        for (Map.Entry<String, Metric> metricEntry : metricByCategory
                                                .entrySet())
                                        {
                                            String newMetricKey =
                                                    metricEntry.getKey() +
                                                            identifierToAdd;
                                            Metric currentMetric = metricEntry
                                                    .getValue();
                                            Metric newMetric = new Metric(
                                                    currentMetric
                                                            .getName() +
                                                            identifierToAdd, currentMetric
                                                    .isPointInTime(), currentMetric
                                                    .isTemporal(), currentMetric
                                                    .isAmsHostMetric(), currentMetric
                                                    .getUnit());
                                            newMetrics
                                                    .put(newMetricKey, newMetric);
                                        }
                                    }
     ...
     */
    public List<MetricDefinition> getMetrics(String stackName,
                                             String stackVersion,
                                             String serviceName,
                                             String componentName,
                                             String metricType) throws AmbariException {
     ...
     * @throws AmbariException
     */
    public Set<AlertDefinition> getAlertDefinitions(String stackName,
                                                    String stackVersion,
                                                    String serviceName) throws AmbariException {
    ...
    public Set<AlertDefinition> getAlertDefinitions(
            ServiceInfo service) throws AmbariException {
        File alertsFile = service.getAlertsFile();

        if (null == alertsFile || !alertsFile.exists())
        {
            LOG.debug("Alerts file for {}/{} not found.", service
                    .getSchemaVersion(), service.getName());

            return Collections.emptySet();
        }

        return alertDefinitionFactory
                .getAlertDefinitions(alertsFile, service.getName());
    }
     ...
     * @throws AmbariException
     */
    public void reconcileAlertDefinitions(
        ...
        for (Cluster cluster : clusterMap.values())
        {
            ...
            StackInfo stackInfo = getStack(stackId.getStackName(), stackId
                    .getStackVersion());

            // creating a mapping between names and service/component for fast lookups
            Collection<ServiceInfo> stackServices = stackInfo
                    .getServices();
            ...
            for (ServiceInfo stackService : stackServices)
            {
                ...
                List<ComponentInfo> components = stackService
                        .getComponents();
            ...
            {
                ServiceInfo stackService = stackServiceMap
                        .get(clusterServiceName);
            ...
            List<AlertDefinitionEntity> entities = alertDefinitionDao
                    .findAll(clusterId);
            ...
            {
                AlertDefinitionEntity entity = mappedEntities
                        .get(stackDefinition.getName());

                // no entity means this is new; create a new entity
                if (null == entity)
                {
                    entity = alertDefinitionFactory
                            .coerce(clusterId, stackDefinition);
                    persist.add(entity);
                    continue;
                }
                ...
                AlertDefinition databaseDefinition = alertDefinitionFactory
                        .coerce(entity);
                if (!stackDefinition.deeplyEquals(databaseDefinition))
                {
                    ...
                    LOG.debug("The alert named {} has been modified from the stack definition and will not be merged", stackDefinition
                            .getName());
                }
            }

            // ambari agent host-only alert definitions
            List<AlertDefinition> agentDefinitions = ambariServiceAlertDefinitions
                    .getAgentDefinitions();
            for (AlertDefinition agentDefinition : agentDefinitions)
            {
                AlertDefinitionEntity entity = mappedEntities
                        .get(agentDefinition.getName());

                // no entity means this is new; create a new entity
                if (null == entity)
                {
                    entity = alertDefinitionFactory
                            .coerce(clusterId, agentDefinition);
                    persist.add(entity);
                }
            }

            // ambari server host-only alert definitions
            List<AlertDefinition> serverDefinitions = ambariServiceAlertDefinitions
                    .getServerDefinitions();
            for (AlertDefinition serverDefinition : serverDefinitions)
            {
                AlertDefinitionEntity entity = mappedEntities
                        .get(serverDefinition.getName());

                // no entity means this is new; create a new entity
                if (null == entity)
                {
                    entity = alertDefinitionFactory
                            .coerce(clusterId, serverDefinition);
                    persist.add(entity);
                }
            }
            ...
            for (AlertDefinitionEntity entity : persist)
            {
                if (LOG.isDebugEnabled())
                {
                    LOG.info("Merging Alert Definition {} into the database", entity
                            .getDefinitionName());
                }
            ...
            for (AlertDefinitionEntity def : alertDefinitionDao
                    .findAll(cluster.getClusterId()))
            {
                AlertDefinition realDef = alertDefinitionFactory
                        .coerce(def);

                AlertDefinitionRegistrationEvent event = new AlertDefinitionRegistrationEvent(cluster
                        .getClusterId(), realDef);
            ...
            List<AlertDefinitionEntity> definitions = alertDefinitionDao
                    .findAllEnabled(clusterId);
            ...
            for (AlertDefinitionEntity definition : definitions)
            {
                ...
                {
                    LOG.info("The {} service has been marked as deleted for stack {}, disabling alert {}", serviceName, stackId, definition
                            .getDefinitionName());
                ...
                {
                    LOG.info("The {} component {} has been marked as deleted for stack {}, disabling alert {}", serviceName, componentName, stackId, definition
                            .getDefinitionName());
            ...
            for (AlertDefinitionEntity definition : definitionsToDisable)
            {
                ...
                AlertDefinitionDisabledEvent event = new AlertDefinitionDisabledEvent(clusterId, definition
                        .getDefinitionId());
     ...
     */
    public Map<String, UpgradePack> getUpgradePacks(String stackName,
                                                    String stackVersion) {
        try
        {
     ...
     */
    public KerberosDescriptor getKerberosDescriptor(String stackName,
                                                    String stackVersion) throws AmbariException {
        StackInfo stackInfo = getStack(stackName, stackVersion);

        String kerberosDescriptorFileLocation = stackInfo
                .getKerberosDescriptorFileLocation();
        ...
        if (kerberosDescriptorFileLocation != null)
        {
            ...
            if (file.canRead())
            {
                try
                {
                    kerberosDescriptor = kerberosDescriptorFactory
                            .createInstance(file);
                }
                catch (IOException e)
                {
                    throw new AmbariException(String
                            .format("Failed to parse kerberos descriptor file %s", file
                                    .getAbsolutePath()), e);
                }
            }
            else
            {
                throw new AmbariException(String
                        .format("Unable to read kerberos descriptor file %s", file
                                .getAbsolutePath()));
            }
        }
     ...
     */
    public KerberosServiceDescriptor[] getKerberosDescriptor(
            ServiceInfo serviceInfo) throws AmbariException {

        KerberosServiceDescriptor[] kerberosServiceDescriptors = null;
        File kerberosFile = (serviceInfo == null) ? null :
                serviceInfo.getKerberosDescriptorFile();

        if (kerberosFile != null)
        {
            try
            {
                kerberosServiceDescriptors = kerberosServiceDescriptorFactory
                        .createInstances(kerberosFile);
            }
            catch (Exception e)
            {
